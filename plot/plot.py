...
categories = ['Male Probability', 'Female Probability']
...
plt.title('Distribution of Male and Female Probabilities with Error Bars and Quartiles')
...
# Save the figure
plt.savefig('barchart_with_quartiles_and_mean2.png', dpi=300, bbox_inches='tight')
plt.close()
